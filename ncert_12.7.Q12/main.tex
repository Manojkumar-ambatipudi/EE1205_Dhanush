...
\solution
\input{tables/ncert-12.7.12Qtab}
...
\begin{figure}[H]
    \centering
    \resizebox{0.4\textwidth}{!}{\input{figs/lapalacecircuit}}
...
\begin{align}
    V\brak{s} &= -\brak{I\brak{s}\frac{1}{sC} + \frac{V\brak{0^-}}{s}}\\
                &= \frac{5\times10^{3}}{25s^2+10^{10}}\label{eq:gate_22_q46_V(s)}
\end{align}
Taking inverse-Laplace transform:
\begin{align}
    v\brak{t} &=200\cos(20000t) 
\end{align}
...
\end{align}
Taking inverse lapalace transform:
\begin{align}
    i\brak{t} &= -\frac{400}{\sqrt{3}}e^{-10000t}\sin(10^4\sqrt{3}t)
    \end{align}
